...
import './MYPTable.styles.css';

export default function MYPTable({ initialData }) {
    const [tableData] = useState(initialData);

    const serviceTypes = ['Regular Course', 'Bootcamp'];

    const serviceDescriptions = {
        'Regular Course': 'Master MYP success with our regular courses, featuring comprehensive content review and practice.',
        'Bootcamp': 'Accelerate your MYP preparation with focused bootcamps.',
    };
