        ...
        <div className="home-3-container">
            ...
            <div className='home-3-z-section'>
                ...
                <div className="home-3-success-container" ref={containerRef}>
                    <AnimatedNumber isVisible={isVisible} end={100} label="students trained" />
                    <AnimatedNumber isVisible={isVisible} end={95} label="success rate" suffix="%" />
                    <AnimatedNumber isVisible={isVisible} end={2000} label="hours of tutoring" />
                </div>
            </div>
        </div>
    )
...
function AnimatedNumber({ isVisible, end, label, suffix = '' }) {
